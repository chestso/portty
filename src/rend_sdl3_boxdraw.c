...
//
// The bitmap is padded on every side so the Xiaolin Wu AA endpoints have
// room to spread beyond the cell boundary.  Lines extend to the bitmap
// edges for continuous coverage at row boundaries when cells are stacked.
